<template>
    <div class="admin-closed-tickets ml-3 mr-3">        
            ...
            <b-row class="mb-2">
                <b-col cols="4">
                    <b-input-group>                       
                        ...
                        <b-form-input
                            id="closed-solicitation-filter-input"
                            type="text"
                            v-model="filterInput"
...
export default {
    ...
    methods: {
        loadSolicitations() {
            const url = `${baseApiUrl}/solicitations/closed?page=${this.page}`;
        ...
        filterSolicitations() {
            this.page = 1;
            const url = `${baseApiUrl}/solicitations/closed?page=${this.page}&ticket=${this.filterInput}`            
            axios.get(url)
                .then(res => {
                    this.solicitations = res.data.data;
                    this.limit = res.data.limit;
